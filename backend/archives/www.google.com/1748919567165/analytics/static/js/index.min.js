...
<base href="/about/">
    ...
    <link href="https://fonts.googleapis.com/css?family=Roboto:100,300,400,500,700|Google+Sans:400,500|Product+Sans:400&amp;lang=en" rel="stylesheet" nonce="gkssexyNDrLtG_iPPbHStA">
    <link rel="stylesheet" href="https://www.gstatic.com/glue/cookienotificationbar/cookienotificationbar.min.css" nonce="gkssexyNDrLtG_iPPbHStA">
    <link href="static/css/index.min.css" rel="stylesheet" nonce="gkssexyNDrLtG_iPPbHStA">
    <script src="static/js/detect.min.js" nonce="gkssexyNDrLtG_iPPbHStA"></script>
    <script nonce="gkssexyNDrLtG_iPPbHStA">window.dataLayer = [{
          'siteName': 'gmp',
          'pageName': 'home',
          'country': 'us',
          'region': 'noram',
    ...
    <!-- Google Tag Manager -->
    <script nonce="gkssexyNDrLtG_iPPbHStA">
...
<svg class="svg-assets" xmlns="http://www.w3.org/2000/svg">
  ...
  <symbol id="h-burger" width="24" height="24" viewBox="0 0 24 24">
    ...
    <script src="https://ajax.googleapis.com/ajax/libs/angularjs/1.6.6/angular.min.js" nonce="gkssexyNDrLtG_iPPbHStA"></script>
    <script src="https://ajax.googleapis.com/ajax/libs/angularjs/1.6.6/angular-animate.min.js" nonce="gkssexyNDrLtG_iPPbHStA"></script>
    <script src="https://ajax.googleapis.com/ajax/libs/angularjs/1.6.6/angular-touch.min.js" nonce="gkssexyNDrLtG_iPPbHStA"></script>
    <script src="static/js/index.min.js" nonce="gkssexyNDrLtG_iPPbHStA"></script>
    <script src="static/js/analytics.min.js" nonce="gkssexyNDrLtG_iPPbHStA"></script>
    ...
    <script src="https://www.gstatic.com/glue/cookienotificationbar/cookienotificationbar.min.js"
        ...
        data-glue-cookie-notification-bar-site-id="marketingplatform.google.com" nonce="gkssexyNDrLtG_iPPbHStA">
    </script>
  </body>
</html>