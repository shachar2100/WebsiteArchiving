...
<base href="/about/">
    ...
    <link href="https://fonts.googleapis.com/css?family=Roboto:100,300,400,500,700|Google+Sans:400,500|Product+Sans:400&amp;lang=en" rel="stylesheet" nonce="q8wGpRnhbFoSod_rUafung">
    <link rel="stylesheet" href="https://www.gstatic.com/glue/cookienotificationbar/cookienotificationbar.min.css" nonce="q8wGpRnhbFoSod_rUafung">
    <link href="static/css/index.min.css" rel="stylesheet" nonce="q8wGpRnhbFoSod_rUafung">
    <script src="static/js/detect.min.js" nonce="q8wGpRnhbFoSod_rUafung"></script>
    <script nonce="q8wGpRnhbFoSod_rUafung">window.dataLayer = [{
          'siteName': 'gmp',
          'pageName': 'home',
          'country': 'us',
          'region': 'noram',
    ...
    <!-- Google Tag Manager -->
    <script nonce="q8wGpRnhbFoSod_rUafung">
...
<svg class="svg-assets" xmlns="http://www.w3.org/2000/svg">
  ...
  <symbol id="h-burger" width="24" height="24" viewBox="0 0 24 24">
    ...
    <script src="https://ajax.googleapis.com/ajax/libs/angularjs/1.6.6/angular.min.js" nonce="q8wGpRnhbFoSod_rUafung"></script>
    <script src="https://ajax.googleapis.com/ajax/libs/angularjs/1.6.6/angular-animate.min.js" nonce="q8wGpRnhbFoSod_rUafung"></script>
    <script src="https://ajax.googleapis.com/ajax/libs/angularjs/1.6.6/angular-touch.min.js" nonce="q8wGpRnhbFoSod_rUafung"></script>
    <script src="static/js/index.min.js" nonce="q8wGpRnhbFoSod_rUafung"></script>
    <script src="static/js/analytics.min.js" nonce="q8wGpRnhbFoSod_rUafung"></script>
    ...
    <script src="https://www.gstatic.com/glue/cookienotificationbar/cookienotificationbar.min.js"
        ...
        data-glue-cookie-notification-bar-site-id="marketingplatform.google.com" nonce="q8wGpRnhbFoSod_rUafung">
    </script>
  </body>
</html>